...
<script type="text/javascript" src="<?php echo base_url('resources/js/fullcalendar.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('resources/js/tasker.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('resources/js/bootbox.js'); ?>"></script>
